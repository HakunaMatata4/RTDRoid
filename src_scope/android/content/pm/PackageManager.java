...
public abstract class PackageManager {
    ...
    /**
     * Flag parameter to retrieve all applications(even uninstalled ones) with
     * data directories. This state could have resulted if applications have
     * been deleted with flag DONT_DELETE_DATA with a possibility of being
     * replaced or reinstalled in future
     */
     ...
     * the two packages have a matching signature.
     */
    ...
    /**
     * Signature check result: this is returned by {@link #checkSignatures} if
     * both packages are signed but there is no matching signature.
     */
    public static final int SIGNATURE_NO_MATCH = -3;

    /**
     * Signature check result: this is returned by {@link #checkSignatures} if
     * either of the given package names are not valid.
     */
    ...
    /**
     * Feature for {@link #getSystemAvailableFeatures} and
     * {@link #hasSystemFeature}: The device has a camera facing away from the
     * screen.
     */
    @SdkConstant(SdkConstantType.FEATURE)
    ...
    /**
     * Feature for {@link #getSystemAvailableFeatures} and
     * {@link #hasSystemFeature}: The device can record audio via a microphone.
     */
    @SdkConstant(SdkConstantType.FEATURE)
     ...
     * sufficient for basic two-finger gesture detection.
     */
    @SdkConstant(SdkConstantType.FEATURE)
    ...
    // * main activity in the category {@link Intent#CATEGORY_LAUNCHER}, or
    // return
    ...
    // *
    // * @return Returns a {@link PermissionInfo} containing information about
    // the
    // * permission.
    // */
    ...
    // */
    // public abstract List<PermissionInfo> queryPermissionsByGroup(String
    // group,
    ...
    // * permissions.
    // *
    // * <p>Throws {@link NameNotFoundException} if a permission group with the
    // given
    // * name can not be found on the system.
    // *
    // * @param name The fully qualified name (i.e.
    // com.google.permission_group.APPS)
    // * of the permission you are interested in.
    // * @param flags Additional option flags. Use {@link #GET_META_DATA} to
    ...
    // */
    // public abstract List<PermissionGroupInfo> getAllPermissionGroups(int
    // flags);
    //
    // /**
    ...
    // * package/application.
    // *
    // * <p>Throws {@link NameNotFoundException} if an application with the
    // given
    ...
    // *
    // * @return {@link ApplicationInfo} Returns ApplicationInfo object
    // containing
    ...
    // *
    // * <p>It is good to make your permission tree name descriptive, because
    // you
    ...
    // * shared user.
    // *
    // * @param sharedUserName The shared user name whose uid is to be
    // retrieved.
    ...
    // * {link #GET_UNINSTALLED_PACKAGES} to modify the data returned.
    // *
    // * @return A List of ApplicationInfo objects, one for each application
    // that
    ...
    // * @see #GET_UNINSTALLED_PACKAGES
    // */
    // public abstract List<ApplicationInfo> getInstalledApplications(int
    // flags);
    //
    // /**
    ...
    // * also allows you to supply a list of more explicit Intents that you
    // would
    ...
    // *
    // * <p><em>Note: unlike most other methods, an empty result set is
    // indicated
    ...
    // * icon.
    // *
    // * @param packageName The name of the package that this icon is coming
    // from.
    // * Can not be null.
    // * @param resid The resource identifier of the desired image. Can not be
    // 0.
    // * @param appInfo Overall information about <var>packageName</var>. This
    // * may be null, in which case the application information will be
    // retrieved
    ...
    // * If intent.getClassName() can not be found or the Intent can not be
    // resolved
    ...
    // *
    // * @param packageName The name of the package that this text is coming
    // from.
    // * Can not be null.
    ...
    // *
    // * @param packageName The name of the package that this xml is coming
    // from.
    // * Can not be null.
    ...
    // */
    // public abstract Resources getResourcesForActivity(ComponentName
    // activityName)
    // throws NameNotFoundException;
    //
    // /**
    ...
    // * @return Returns the application's Resources.
    // * @throws NameNotFoundException Thrown if the resources for the given
    // * application could not be loaded (most likely because it was
    // uninstalled).
    // */
    ...
    // * @see #getResourcesForApplication(ApplicationInfo)
    // */
    // public abstract Resources getResourcesForApplication(String
    // appPackageName)
    // throws NameNotFoundException;
    //
    // /**
    ...
    // *
    // */
    // public PackageInfo getPackageArchiveInfo(String archiveFilePath, int
    // flags) {
    ...
    // * be posted back to the given observer. An installation will fail if the
    // calling context
    // * lacks the {@link android.Manifest.permission#INSTALL_PACKAGES}
    // permission, if the
    // * package named in the package file's manifest is already installed, or
    // if there's no space
    ...
    // installation is
    // * complete. {@link IPackageInstallObserver#packageInstalled(String, int)}
    // will be
    // * called when that happens. observer may be null to indicate that no
    // callback is desired.
    // * @param flags - possible values: {@link #INSTALL_FORWARD_LOCK},
    // * {@link #INSTALL_REPLACE_EXISTING}, {@link #INSTALL_ALLOW_TEST}.
    // * @param installerPackageName Optional package name of the application
    ...
    // calling context
    // * lacks the {@link android.Manifest.permission#DELETE_PACKAGES}
    // permission, if the
    ...
    // * be posted back to the given observer. A deletion will fail if the
    // calling context
    // * lacks the {@link android.Manifest.permission#DELETE_CACHE_FILES}
    // permission, if the
    // * named package cannot be found, or if the named package is a
    // "system package".
    // *
    // * @param packageName The name of the package to delete
    // * @param observer An observer callback to get notified when the cache
    // file deletion
    // * is complete.
    // * {@link
    // android.content.pm.IPackageDataObserver#onRemoveCompleted(String,
    ...
    // permission.
    // *
    // * @param packageName The name of the package whose size information is to
    // be retrieved
    // * @param observer An observer callback to get notified when the operation
    // * is complete.
    // * {@link
    ...
    // * code, data and cache sizes of the package) and a boolean value
    // representing
    ...
    // * assigning preferred activities and this can not be directly modified.
    // *
    // * Replaces an existing preferred activity mapping to the system, and if
    ...
    // */
    // @Deprecated
    // public abstract void replacePreferredActivity(IntentFilter filter, int
    // match,
    // ComponentName[] set, ComponentName activity);
    //
    // /**
    ...
    // service, provider).
    // * This setting will override any enabled state which may have been set by
    // the component in its
    // * manifest.
    // *
    // * @param componentName The component to enable
    // * @param newState The new enabled state for the component. The legal
    ...
    // */
    // public abstract void setComponentEnabledSetting(ComponentName
    // componentName,
    ...
    // */
    // public abstract int getComponentEnabledSetting(ComponentName
    // componentName);
    //
    // /**
    ...
    // * This setting will override any enabled state which may have been set by
    // the application in
    // * its manifest. It also overrides the enabled state set in the manifest
    // for any of the
    ...
    // * and
    // * {@link #COMPONENT_ENABLED_STATE_DEFAULT}
    // * The last one removes the setting, thereby restoring the applications's
    // state to
    ...
    // vice versa.
    // * Since this may take a little while, the result will
    // * be posted back to the given observer. This call may fail if the calling
    // context
    // * lacks the {@link android.Manifest.permission#MOVE_PACKAGE} permission,
    // if the
    // * named package cannot be found, or if the named package is a
    // "system package".
    // *
