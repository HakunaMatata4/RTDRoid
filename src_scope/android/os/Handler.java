...
public class Handler{
    ...
    private RTHandler rtHandlerDelegator;
    ...
    public void dispatchMessage(Message msg) {
        if (msg.callback != null) {
            ...
            } else if (rtHandlerDelegator != null) {
                rtHandlerDelegator.handleMessage(msg);
            } else {
                handleMessage(msg);
            }
        }
     ...
     * current thread. If there isn't one, this handler won't be able to receive
     * messages.
     */
    public Handler() {
        rtHandlerDelegator = null;
        Looper.prepare();
    ...
    public Handler(Looper looper, RTHandler rth) {
        mLooper = looper;
        mQueue = looper.mQueue;
        mCallback = null;
        rtHandlerDelegator = rth;
    }
    ...
    public final boolean sendMessageDelayed(Message msg, long delayMillis) {
        ...
        return sendMessageAtTime(msg, System.nanoTime() + delayMillis * 1000000);
    }
    ...
    private final class MessengerImpl extends IMessenger.Stub {
        ...
        public void send(RTMessage rtmsg) {
