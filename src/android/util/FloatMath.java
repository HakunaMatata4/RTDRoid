...
public class FloatMath {
     ...
     */
    // Using FIJIs @Import for direct C calls
    // C implementation in fiji_android_lib/jni/src/android_util_FloatMath.c
    @Import
    public static native float sqrtFloat(float value);
