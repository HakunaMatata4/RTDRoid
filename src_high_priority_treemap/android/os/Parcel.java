...
public final class Parcel {
     ...
     * 
     * @param size The new capacity of the parcel, in bytes. Can not be less
     *            than {@link #dataSize} -- that is, you can not drop existing
    ...
    // }
    // }
    // TODO comment out all method about Binder------------
    ...
    public final void writeValue(Object v) {
        if (v == null) {
            ...
            writeInt(VAL_MAP);
            writeMap((Map) v);
            // TODO ------------ comment out bundle relater options
...
//                return readBundle(loader);
     ...
     *         has been written.
     * @throws BadParcelableException Throws BadParcelableException if there was
     *             an error trying to instantiate the Parcelable.
     */
    public final <T extends Parcelable> T readParcelable(ClassLoader loader) {
        ...
        synchronized (mCreators) {
            ...
            if (creator == null) {
                try {
                    Class c = loader == null ?
                            Class.forName(name) : Class.forName(name, true,
                                    loader);
