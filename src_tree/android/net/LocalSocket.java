...
public class LocalSocket {
     ...
     * called, but it seems like a reasonable rule is "as soon as possible, but
     * not in a context where IOException cannot be thrown"
     * 
     ...
     * @throws IOException if socket is in invalid state or the address does not
     *             exist.
     */
