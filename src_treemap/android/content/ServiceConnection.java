 ...
 * {@link android.app.Service} and {@link Context#bindService
...
public interface ServiceConnection {
     ...
     * 
     * @param name The concrete component name of the service that has been
     *            connected.
     * @param service The IBinder of the Service's communication channel, which
     *            you can now make calls on.
     */
     ...
     * {@link #onServiceConnected} when the Service is next running.
     * 
     * @param name The concrete component name of the service whose connection
     *            has been lost.
     */
