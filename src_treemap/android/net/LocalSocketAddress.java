 ...
 * and android.net.LocalServerSocket. On the Android system, these names refer
 * to names in the Linux abstract (non-filesystem) UNIX domain namespace.
 */
public class LocalSocketAddress
{
    ...
    public enum Namespace {
        ...
        ABSTRACT(0),
        /**
         * A socket in the Android reserved namespace in /dev/socket. Only the
         * init process may create a socket here.
         */
        RESERVED(1),
        /**
